...
public class Jogl2Example {
    ...
    public static void main(String[] args) throws Exception {
        Jogl2Example test = new Jogl2Example();
    ...
    private void createWindow() {
        window = new Frame("JOGL 2 Example");
    ...
    private void createView() {
        ...
        for (Entry<String, UniformParameters> postprocessorEntry : postprocessors
                .entrySet()) {
            actualRenderer = createScenePostprocessor(
                    postprocessorEntry.getKey(), actualRenderer,
                    postprocessorEntry.getValue());
        }
    ...
    private ScenePostprocessor createScenePostprocessor(
        ...
        FboScenePostprocessor scenePostprocessor = new FboScenePostprocessor();
